 ...
 */
public class EndRouteAdapterItem extends ArrayAdapter<RouteItem> {
    ...
    public EndRouteAdapterItem(Context context, List<RouteItem> items, FragmentActivity listFragment) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (route_no < route_max){
            ...
            Log.e("curr position", String.valueOf(current_position));
    ...
    private void setClickListeners(ViewHolder viewHolder, final RouteItem item){
        viewHolder.time.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                EndMapNavFragment wdf = EndMapNavFragment.newInstance(item);
