...
public class EndMapNavFragment extends Fragment {
    ...
    public static EndMapNavFragment newInstance(RouteItem routeItem) {
        EndMapNavFragment fragment = new EndMapNavFragment();
